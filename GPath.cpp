...
void GPath::ChopCubicAt(const GPoint src[4], GPoint dst[7], float t) {
    GPoint p01 = (1 - t) * src[0] + t * src[1]; // Point between P0 and P1
    GPoint p12 = (1 - t) * src[1] + t * src[2]; // Point between P1 and P2
    GPoint p23 = (1 - t) * src[2] + t * src[3]; // Point between P2 and P3
    
    GPoint p012 = (1 - t) * p01 + t * p12;      // Between P01 and P12
    GPoint p123 = (1 - t) * p12 + t * p23;      // Between P12 and P23
    
    GPoint p0123 = (1 - t) * p012 + t * p123;   // The new split point on the curve
